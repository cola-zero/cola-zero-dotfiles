...
(setq elmo-imap4-default-user "colazero@mail.mkoga.net")
;; POP サーバの設定
(setq elmo-pop3-default-server "arch.cs.kumamoto-u.ac.jp")
;; SMTP サーバの設定
(setq wl-smtp-posting-server "smtp.gmail.com")
(setq wl-smtp-posting-port 587)
(setq wl-smtp-authenticate-type "plain")
(setq wl-smtp-posting-user "colazero@mail.mkoga.net")
