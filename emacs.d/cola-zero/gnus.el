...
(setq user-full-name "Masahiro Koga"
      user-mail-address "colazero@mail.mkoga.net")
...
(defvar my-gnus-mail-addres-regex "colazero\\(\\+[^@]+\\)?@mail\\.mkoga\\.net"
...
(setq ;; Do not use mailcrypt.
      ...
      gnus-posting-styles '((".*" (name "Masahiro Koga")))
...
;; ;; my mail address
;; (setq bbdb-user-mail-names "colazero@mail\\.mkoga\\.net")
